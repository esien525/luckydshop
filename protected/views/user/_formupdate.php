...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<tr>
		...
		<td><?php echo $form->passwordField($model,'password',array('size'=>60,'maxlength'=>300,'value'=>base64_decode($model->password))); ?>
		<?php echo $form->error($model,'password'); ?></td>
	</tr>

	<tr>
		<td><?php echo $form->labelEx($model,'password2'); ?></td>
		<td><?php echo $form->passwordField($model,'password2',array('size'=>60,'maxlength'=>300,'value'=>base64_decode($model->password))); ?>
