		...
		<div class="category-outer">
			<div class="category-slider single-slider">
				<ul>
					...
					$queryBanner="Select * FROM banner WHERE banner_location='Product Page' ORDER BY banner_order";
			...
			<div class="category-outer__text">
				<h2 class="category-outer__text__title text-uppercase">Product Listing</h2>
			</div>
		</div>
	</div>
</section>
