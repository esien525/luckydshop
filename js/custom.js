...
jQuery(function ($) {
	...
	if ($j("#countdown1").length > 0){$j('#countdown1').countdown({until: new Date(2016, 05, 04)});}
    if ($j("#countdown2").length > 0){$j('#countdown2').countdown({until: new Date(2016, 05, 10)});}
    if ($j("#countdown3").length > 0){$j('#countdown3').countdown({until: new Date(2016, 05, 12)});}
    if ($j("#countdown4").length > 0){$j('#countdown4').countdown({until: new Date(2016, 05, 13)});}
    if ($j("#countdown4").length > 0){$j('#countdown5').countdown({until: new Date(2016, 05, 13)});}
