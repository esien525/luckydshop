...
$queryFeedbackToday="Select * FROM app_feedback WHERE feedback_submission_datetime between '$daily 00:00:00' AND '$datetoday 00:00:00' and feedback_status='open'";
...
if($num_rows_FeedbackToday!=0){
	...
	mysql_query("INSERT INTO `app_luckydraw` (`luckydraw_feedback_id`, `luckydraw_type`, `luckydraw_datetime`, `luckydraw_status`) VALUES ('$thisid', 'Daily', NOW(), 'open');");
	mysql_query("UPDATE app_feedback SET feedback_status='daily win' WHERE feedback_id='$thisid'");
}
?>