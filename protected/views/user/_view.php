<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('user_datejoin')); ?>:</b>
	<?php echo CHtml::encode($data->user_datejoin); ?>
	<br />

	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('user_contactnumber')); ?>:</b>
	<?php echo CHtml::encode($data->user_contactnumber); ?>
	<br />
